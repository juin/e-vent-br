...
echo '<form method="post" action="lista_atividade.php">';
foreach ($eventos as $evento) {	
	 ...
	 if ($coord_aux){
	 	...
	 	echo "<a href=\"" . URL . "apresentacao/Evento/lista_atividade.php?cod_evento=" . $evento->getCodEvento() . "\">".$evento->getNome() ." | ". $evento -> getStatus() . "</a><br/>";
	 }
