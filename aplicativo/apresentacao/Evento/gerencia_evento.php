...
if ($atividades != null) {
	foreach ($atividades as $atividade) {
		echo "<li><a href=\"".URL."apresentacao/Evento/atividades/gerencia_atividade.php?cod_atividade=".$atividade->getCodAtividadeAgenda()."\">".$atividade->getNome()."-".$atividade -> getStatus()."</a></li>";
	}
}
