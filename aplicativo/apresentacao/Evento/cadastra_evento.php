...
<form method="post" action="#" enctype="multipart/form-data">
	...
	<label for="dtini">Data de In�cio:</label><input name="dtini" type="date"/><br />
	<label for="dtfim">Data de T�rmino:</label><input name="dtfim" type="date"/><br />
	<label for="dtinsc"><i>Deadline</i> de Inscri��o:</label><input name="dtinsc" type="date"/><br />
...
<?php
	if(isset($_POST['nome'])){
		...
		$retorno = FachadaEvento::getInstancia()->criarEvento($evento);
