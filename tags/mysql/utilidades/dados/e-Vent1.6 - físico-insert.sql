...
INSERT INTO Usuario (cod_usuario, nome_certificado, sexo, data_nascimento, cpf, rg, login, senha, telefone1, email, instituicao, categoria, nivel_acesso, notifica, status, data_hora_cadastro) VALUES 
	(1, 'José da Silva Xavier', 'Masculino', '1928-05-26', '11111111111', '1111111111', 'josesxavier', '123', '7799876985', 'josesxavier@gmail.com', 'IFBA', 'Estudante', 'Comum', 'Sim', 'Ativo', now()),
	(2, 'Felipe Souza Cruz', 'Masculino', '1989-07-06', '22222222222', '2222222222', 'felipecruz', '123', '7794853678', 'felipecruz@gmail.com', 'Coelba', 'Profissional', 'Comum', 'Não', 'Ativo', now());

-- =============
-- Tabela Evento
-- =============
INSERT INTO Evento (cod_evento, nome, sigla, data_inicio, data_fim, status, pagamento) VALUES
	(1, 'Semana de Tecnologia da Informação', 'Week-IT 2013', '2013-07-04', '2013-07-07', 'Encerrado', 'Gratuito'),
	(2, 'Semana de Ciência e Tecnologia', 'SECITEC 2013', '2013-10-16', '2013-10-20', 'Encerrado', 'Gratuito');
